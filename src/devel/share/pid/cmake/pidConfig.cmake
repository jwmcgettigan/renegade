...
if("TRUE" STREQUAL "TRUE")
  set(pid_SOURCE_PREFIX /home/nvidia/racecar-ws/src/pid)
  set(pid_DEVEL_PREFIX /home/nvidia/racecar-ws/src/devel)
...
if(NOT "/home/nvidia/racecar-ws/src/devel/include;/home/nvidia/racecar-ws/src/pid/include " STREQUAL " ")
  set(pid_INCLUDE_DIRS "")
  set(_include_dirs "/home/nvidia/racecar-ws/src/devel/include;/home/nvidia/racecar-ws/src/pid/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'pid' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/nvidia/racecar-ws/src/pid/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/nvidia/racecar-ws/src/devel/lib;/opt/ros/kinetic/lib)
