...
class Functions:
    ...
    def hough_transform(image, side):
        ...
        if houghLines is not None:
            ...
            if side == 'left':
    	        Functions.lastHoughLinesLeft = houghLines
            if side == 'right':
                Functions.lastHoughLinesRight = houghLines

            return houghLines
        elif Functions.lastHoughLinesLeft is not None or Functions.lastHoughLinesRight is not None:
            Functions.linesExist = False
    	    if side == 'left':
                return Functions.lastHoughLinesLeft
            if side == 'right':
                return Functions.lastHoughLinesRight
        else:
            Functions.linesExist = False
    #=============================================================
